...
hs.hotkey.bind({"cmd", "alt", "ctrl", "shift"}, "pad8", windowTools.splitUpperMiddle)
hs.hotkey.bind({"cmd", "alt", "ctrl", "shift"}, "pad2", windowTools.splitLowerMiddle)
...
hs.hotkey.bind({"cmd", "alt", "ctrl", "shift"}, "U", windowTools.splitMiddle)
